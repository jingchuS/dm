...
export default {
  ...
  watch: {
    ...
    inTheater() {
      ...
      scroll({
          el:'#mod-scroll',
          url1:'list/more/?order=3&lat=&lng=&more=a&pageSize=10&interface%5Buuid%5D=2c0b3fbc-df62-11e8-8b1e-1418774d6214&interface%5Breqid%5D=61ad3b2e3e98fd35b4eac34e134ac9d4&interface%5Blat%5D=&interface%5Blng%5D=&offset=1&page=',
          url2:'&pageSize=10',
          url3:'',
          url4:'',
          data:this.doumilist,

  ...
  async beforeCreate() {
    ...
    let result = await http({
      ...
      url:
        'list/more/?order=' +
        this.type_code +
        '&lat=&lng=&more=a&pageSize=10&interface%5Buuid%5D=f0c3b478-e4c7-11e8-b37b-1418774d0625&interface%5Breqid%5D=531594e4473be7202676764b850c9756&interface%5Blat%5D=&interface%5Blng%5D=&offset=1&page=2&pageSize=10'
    })
